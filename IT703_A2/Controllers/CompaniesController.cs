...
namespace IT703_A2.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone,Email,Detail")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone,Email,Detail")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Companys'  is null.");
            }
            var company = await _context.Companys.FindAsync(id);
            if (company != null)
            {
