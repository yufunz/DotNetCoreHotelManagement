...
namespace IT703_A2.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Rate,NumOfBeds,Image,IsDeleted")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Rate,NumOfBeds,Image,IsDeleted")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
